...
app.use(cors())
 ...
 app.get("/search",(request,response) =>{
   ...
   let results = [];
   words.forEach((sk)=>{
    if(index.has(sk.toLowerCase()) == true){
        const result =index.get(sk.toLowercase());
        result.foreach((doc) => results.push(doc));
    )
   });
...
const documents = [
    ...
    },
    {
      ...
      content:
        "JavaScript is standardized in the ECMAScript language specification.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      content: "JavaScript has built-in support for arrays.",
    },
    {
      id: 6,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object",
      content: "Everything in JavaScript is an object or a primitive.",
    },
    {
      id: 7,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function",
      content: "Functions in JavaScript are first-class objects.",
    },
    {
      id: 8,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String",
      content: "JavaScript has built-in string manipulation capabilities.",
    },
    {
      id: 9,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number",
      content: "JavaScript supports both integer and floating-point numbers.",
    },
    {
      id: 10,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean",
      content: "Boolean values in JavaScript are true or false.",
    },
    {
      id: 11,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date",
      content: "JavaScript has built-in date and time manipulation capabilities.",
    },
    {
      id: 12,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp",
      content:
        "Regular expressions are supported in JavaScript for pattern matching.",
    },
    {
      id: 13,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Control_flow_and_error_handling",
      content:
        "JavaScript uses control flow statements like if, switch, and loops.",
    },
    {
      id: 14,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let",
      content: "The let keyword is used to declare block-scoped variables.",
    },
    {
      id: 15,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/const",
      content: "The const keyword is used to declare block-scoped constants.",
    },
    {
      id: 16,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/var",
      content:
        "The var keyword declares variables globally or locally to the function.",
    },
    {
      id: 17,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise",
      content: "Promises are used to handle asynchronous operations.",
    },
    {
      id: 18,
    ...
    },
    {
      ...
      content: "The Set object lets you store unique values of any type.",
    },
    {
      id: 22,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/WeakMap",
      content:
        "WeakMap allows you to store key-value pairs where keys are objects.",
    },
    {
      id: 23,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/WeakSet",
      content:
        "WeakSet lets you store unique objects without preventing garbage collection.",
    },
    {
      id: 24,
    ...
    {
      id: 26,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/console",
      content:
    ...
    },
    {
      ...
      content: "The reduce() method executes a reducer function on each element.",
    },
    {
      id: 33,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort",
      content: "The sort() method sorts the elements of an array.",
    },
    {
      id: 34,
    ...
    },
    {
      ...
      content:
        "The find() method returns the value of the first element that satisfies the testing function.",
    },
    {
      id: 36,
    ...
    },
    {
      ...
      content: "The concat() method is used to merge two or more arrays.",
    },
    {
      id: 39,
    ...
    },
    {
      ...
      content: "The pop() method removes the last element from an array.",
    },
    {
      id: 41,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/shift",
      content: "The shift() method removes the first element from an array.",
    },
    {
      id: 42,
    ...
    },
    {
      ...
      content:
        "The substring() method returns a part of the string between two specified indexes.",
    },
    {
      id: 44,
    ...
    },
    {
      ...
      content: "The trim() method removes whitespace from both ends of a string.",
    },
    {
      id: 46,
    ...
    },
    {
      ...
      content:
        "The replace() method returns a new string with some or all matches replaced.",
    },
    {
      id: 49,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split",
      content: "The split() method splits a string into an array of substrings.",
    },
    {
      id: 50,
    ...
    },
    {
      ...
      content: "Math.PI returns the value of Pi, approximately 3.14159.",
    },
    {
      id: 53,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/random",
      content: "Math.random() returns a floating-point, pseudo-random number.",
    },
    {
      id: 54,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/abs",
      content: "Math.abs() returns the absolute value of a number.",
    },
    {
      id: 55,
    ...
    },
    {
      ...
      content: "Math.sqrt() returns the square root of a number.",
    },
    {
      id: 58,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/pow",
      content: "Math.pow() returns the base to the exponent power.",
    },
    {
      id: 59,
    ...
    },
    {
      ...
      content: "Math.max() returns the largest of zero or more numbers.",
    },
    {
      id: 61,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/min",
      content: "Math.min() returns the smallest of zero or more numbers.",
    },
    {
      id: 62,
    ...
    },
    {
      ...
      content:
        "Object.getOwnPropertyDescriptor() returns a property descriptor for an object.",
    },
    {
      id: 71,
    ...
    },
    {
      ...
      content: "Every JavaScript object has a prototype property.",
    },
    {
      id: 73,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/prototype",
      content:
        "Function.prototype allows you to define methods on all function objects.",
    },
    {
      id: 74,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/prototype/toString",
      content:
    ...
    },
    {
      ...
      content:
        "Promise.all() returns a single Promise that resolves when all of the promises have resolved.",
    },
    {
      id: 76,
    ...
    },
    {
      ...
      content:
        "The then() method returns a Promise and executes its argument once the Promise is resolved.",
    },
    {
      id: 80,
    ...
    {
      id: 81,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Working_with_asynchronous_code",
      content:
        "JavaScript handles asynchronous code with callbacks, promises, and async/await.",
    },
    {
      id: 82,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/async_function",
      content: "An async function is a function declared with the async keyword.",
    },
    {
      id: 83,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/await",
      content: "The await keyword is used to wait for a Promise to resolve.",
    },
    {
      id: 84,
      link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Working_with_Objects#Object_methods",
      content: "JavaScript provides various methods for object manipulation.",
    },
    {
      id: 85,
  ...
  
    {
      ...
      content:
        "The getDate() method returns the day of the month (1-31) for a specified date.",
    },
    {
      id: 89,
    ...
    },
    {
      ...
      content: "The setMonth() method sets the month for a specified date.",
    },
    {
      id: 95,
    ...
    },
    {
      ...
      content:
        "The toISOString() method returns the date as a string in ISO format.",
    },
  ];
...
/*
  const query = "javaScript" // or javascript
